...
public class PSMAnnotationTypes {
	...
	public static final String PERCOLATOR_ANNOTATION_TYPE_Q_VALUE = "q-value";
	public static final String PERCOLATOR_ANNOTATION_TYPE_P_VALUE = "p-value";
	public static final String PERCOLATOR_ANNOTATION_TYPE_SVM_SCORE= "SVM Score";
	...
	public static List<FilterablePsmAnnotationType> getFilterablePsmAnnotationTypes(String programName, int RUNTYPE ) {
		...
		if( programName.equals(ConverterConstants.PROGRAM_NAME_PERCOLATOR) ) {
			...
			{
				FilterablePsmAnnotationType type = new FilterablePsmAnnotationType();
				type.setName(PERCOLATOR_ANNOTATION_TYPE_Q_VALUE);
				type.setDescription("Q-value (maximum FDR level at which this would be included)");
				type.setFilterDirection(FilterDirectionType.BELOW);
				type.setDefaultFilter(true);
			...
			{
				FilterablePsmAnnotationType type = new FilterablePsmAnnotationType();
				type.setName(PERCOLATOR_ANNOTATION_TYPE_P_VALUE);
			...
			{
				FilterablePsmAnnotationType type = new FilterablePsmAnnotationType();
				type.setName(PERCOLATOR_ANNOTATION_TYPE_SVM_SCORE);
				type.setDescription("Score generated by support vector machine");
				type.setFilterDirection(FilterDirectionType.ABOVE);
				type.setDefaultFilter(false);
