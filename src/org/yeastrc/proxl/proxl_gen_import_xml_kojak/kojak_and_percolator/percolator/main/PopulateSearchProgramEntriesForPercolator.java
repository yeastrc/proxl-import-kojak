	...
	public void populateSearchProgramEntriesForPercolator( ProxlInput proxlInputRoot, String percolatorVersion ) throws ProxlGenXMLDataException {
...

		{
...

			{
				...
				filterablePeptideAnnotationType.setDefaultFilterValue( KojakPercolatorDefaultFilterValueConstants.PERCOLATOR_PEPTIDE_Q_VALUE_DEFAULT );
		...
		*/
		...
		/////////////  Filterable
		{
...

			{
				...
				filterablePsmAnnotationType.setDefaultFilterValue( KojakPercolatorDefaultFilterValueConstants.PERCOLATOR_PEPTIDE_Q_VALUE_DEFAULT );
