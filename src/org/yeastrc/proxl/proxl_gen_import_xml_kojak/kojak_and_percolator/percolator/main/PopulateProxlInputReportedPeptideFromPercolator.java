 ...
 *
 */
public class PopulateProxlInputReportedPeptideFromPercolator {

	private static final Logger log = Logger.getLogger( PopulateProxlInputReportedPeptideFromPercolator.class );

	//  private constructor
	private PopulateProxlInputReportedPeptideFromPercolator() {}


	public static PopulateProxlInputReportedPeptideFromPercolator getInstance() {

		return new PopulateProxlInputReportedPeptideFromPercolator();
	}
