package org.yeastrc.proxl.proxl_gen_import_xml_kojak.psm_processing;
...
import org.yeastrc.proxl.proxl_gen_import_xml_kojak.percolator.objects.PsmIdSplitObject;
import org.yeastrc.proxl.proxl_gen_import_xml_kojak.percolator.utils.SplitKojakPsmId;
...
public class PsmMatchingAndCollection {
	...
	public void addKojakPsmData( 
		...
		} else if ( ! "-".equals( peptide_2 ) && ( ! "-".equals( link_1 ) ) && ( ! "-".equals( link_2 ) )  ) {
		
			//  More than likely a cross link
