...
public class PopulateProxlInputPsm {

	private static final Logger log = Logger.getLogger( PopulateProxlInputPsm.class );

	//  private constructor
	private PopulateProxlInputPsm() {}


	public static PopulateProxlInputPsm getInstance() {

		return new PopulateProxlInputPsm();
	}
